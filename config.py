...
# NOTE: you must individually subscribe to email updates from each service for example https://status.onesignal.com/ https://status.openai.com/ https://status.claude.com/ etc
